...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Event'
        db.create_table(u'photo_contest_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'photo_contest', ['Event'])

        # Adding model 'Profile'
        db.create_table(u'photo_contest_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'photo_contest', ['Profile'])


    def backwards(self, orm):
        # Deleting model 'Event'
        db.delete_table(u'photo_contest_event')

        # Deleting model 'Profile'
        db.delete_table(u'photo_contest_profile')
