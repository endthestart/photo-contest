...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'photo_contest_photo', 'thumbnail')


        # Changing field 'Photo.photo'
        db.alter_column(u'photo_contest_photo', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Adding field 'Photo.thumbnail'
        db.add_column(u'photo_contest_photo', 'thumbnail',
        ...
        # Changing field 'Photo.photo'
        db.alter_column(u'photo_contest_photo', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
